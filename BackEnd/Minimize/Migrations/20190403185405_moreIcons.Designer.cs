...
namespace Minimize.Migrations
{
    ...
    [Migration("20190403185405_moreIcons")]
            ...
            modelBuilder.Entity("Minimize.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { CategoryId = 3, CategoryDescription = "Toolbox", CategoryImg = "/Images/Tools_Icon.png", CategoryName = "Tools" },
                        new { CategoryId = 4, CategoryDescription = "Computers, phones", CategoryImg = "/Images/electronics_icon.png", CategoryName = "Electronics" }
                    );
                });
